...
// import {Skyky} from 'three/addons/objects/Sky.js'
...
const floorNormalTexture = textureLoader.load('./floor/coast_sand_rocks_02_1k/coast_sand_rocks_02_disp_1k.jpg')
const floorDisplacementTexture = textureLoader.load('./floor/coast_sand_rocks_02_1k/coast_sand_rocks_02_nor_gl_1k.jpg')
...
sky.material.uniforms['mieCoefficient'].value = 0.2
sky.material.uniforms['mieDirectionalG'].value = 0.9
sky.material.uniforms['sunPosition'].value.set(0.3, -0.038, -0.95)

scene.fog = new THREE.FogExp2('#04343f', 0.18) 
